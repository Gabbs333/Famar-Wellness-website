...
console.log('Contact function - Supabase Key present:', supabaseKey ? 'Yes' : 'No');
console.log('Contact function - Using key type:', 
  process.env.SUPABASE_SERVICE_ROLE_KEY ? 'SERVICE_ROLE' : 
  process.env.SUPABASE_ANON_KEY ? 'ANON' : 'NONE');
console.log('Contact function - Key first 20 chars:', supabaseKey ? supabaseKey.substring(0, 20) + '...' : 'None');
