-- =============================================================================
-- SUPABASE CMS SCHEMA - Version Améliorée (Corrigée)
-- =============================================================================
...
BEGIN
    ...
    RAISE NOTICE 'Anciennes contraintes supprimees (si elles existaient)';
END $$;
...
INSERT INTO cms_components (name, type, configuration, is_public) VALUES
  ...
  ('Contact Form', 'form', '{"fields": [{"name": "title", "type": "text", "label": "Titre du formulaire"}, {"name": "fields", "type": "select", "label": "Champs a inclure", "multiple": true, "options": [{"value": "name", "label": "Nom"}, {"value": "email", "label": "Email"}, {"value": "phone", "label": "Telephone"}, {"value": "message", "label": "Message"}]}]}', true)
ON CONFLICT DO NOTHING;

-- =============================================================================
-- MESSAGE DE SUCCÈS (SIMPLIFIÉ POUR ÉVITER LES ERREURS)
-- =============================================================================

DO $$
BEGIN
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'SCHEMA CMS SUPABASE CREE AVEC SUCCES - VERSION AMELIOREE!';
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'Ameliorations incluses:';
    ...
    RAISE NOTICE '4. Toutes les syntaxes corrigees';
    RAISE NOTICE '5. Types UUID compatibles avec auth.users';
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'Fonctions creees:';
    RAISE NOTICE '- generate_slug() : Genere des slugs SEO-friendly';
    RAISE NOTICE '- is_slug_unique() : Verifie l''unicite des slugs';
    RAISE NOTICE '- generate_unique_slug() : Genere des slugs uniques';
    RAISE NOTICE '- calculate_reading_time() : Calcule le temps de lecture';
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'Triggers automatiques:';
    RAISE NOTICE '- Generation automatique de slugs pour cms_pages';
    RAISE NOTICE '- Generation automatique de slugs pour blog_categories';
    RAISE NOTICE '- Generation automatique de slugs pour blog_tags';
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'Tables creees/mises a jour:';
    ...
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'Le schema est maintenant pret pour l''utilisation!';
    RAISE NOTICE '====================================================';
END $$;

-- Message final
SELECT 
    '✅ Schema CMS ameliore cree avec succes!' AS status,
